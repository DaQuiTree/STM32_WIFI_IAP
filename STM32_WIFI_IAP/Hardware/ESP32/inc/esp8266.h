...
#define ESP8266_RST_Pin          GPIO_Pin_2    //复位管脚
#define ESP8266_RST_Pin_Port     GPIOB    //复位 
#define ESP8266_RST_Pin_Periph_Clock  RCC_APB2Periph_GPIOB       //复位时钟
...
#define RX_BUF_MAX_LEN 2048       //最大字节数

struct STRUCT_USART_Fram   //数据帧结构体
{
    char Data_RX_BUF[RX_BUF_MAX_LEN];
    u16 InfAll;
    u16 FramLength;                               // 14:0 
    u8 FramFinishFlag;                                // 15 
};
...
bool ESP8266_RecieveData(u8 **buf, int *plen, const int maxsz);
